...
* Navigate to the *Kafka Console > Groups > demo-cg* to view the first consumers and partitions being assigned to each consumer.
+
...
* Navigate to the *Kafka Console > Topics > Groups > demo-cg* and expand consumer cg-c1 we started previously.
