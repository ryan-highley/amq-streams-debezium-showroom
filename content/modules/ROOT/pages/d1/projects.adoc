...
A project named *{ocp4_starter_project}* has already been created for you. Start by exploring it through the *OCP Console* tab on the right side of this page.
...
[.bordershadow]
image::d1/openshift-console-project.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/openshift-console-topology.png[link="self",window=_blank]
