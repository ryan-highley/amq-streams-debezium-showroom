...
[.bordershadow]
image::d1/roadshow-app-architecture-parksmap-2.png[link="self",window=_blank]
...
+
image::d1/parksmap-route-create-1.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-route-created.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-route-empty-map.png[link="self",window=_blank]
