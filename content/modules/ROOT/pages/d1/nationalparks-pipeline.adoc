...
[.bordershadow]
image::d1/devops-pipeline-flow.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/tekton-architecture.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/devops_create_pipeline.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/devops_pipeline_builder_yaml.png[link="self",window=_blank]
...
image::d1/devops_pipeline_builder_java.png[link="self",window=_blank]
...
image::d1/devops_pipeline_tasks_java.png[link="self",window=_blank]
...
image::d1/devops_pipeline_workspaces_java.png[link="self",window=_blank]
...
// image::d1/devops_pipeline_builder_dotnet.png[Pipeline Builder Java]
...
// image::d1/devops_pipeline_tasks_dotnet.png[Pipeline Tasks Java]
...
// image::d1/devops_pipeline_workspaces_dotnet.png[Pipeline Workspaces Java]
...
// image::d1/devops_pipeline_builder_js.png[Pipeline Builder Java]
...
// image::d1/devops_pipeline_tasks_js.png[Pipeline Tasks Java]
...
// image::d1/devops_pipeline_workspaces_js.png[Pipeline Workspaces Java]
...
// image::d1/devops_pipeline_builder_python.png[Pipeline Builder Java]
...
// image::d1/devops_pipeline_tasks_python.png[Pipeline Tasks Java]
...
// image::d1/devops_pipeline_workspaces_python.png[Pipeline Workspaces Java]
// --
====
...
[.bordershadow]
image::d1/nationalparks-codechanges-pipeline-pvc-1.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/nationalparks-codechanges-pipeline-pvc.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/devops-pipeline-start-1.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/devops-pipeline-start-2.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/devops-pipeline-run-1.png[link="self",window=_blank]

The click on the `PipelineRun`:

[.bordershadow]
image::d1/devops-pipeline-run-java-2.png[link="self",window=_blank]

Then click on the *Task* running to check logs:

[.bordershadow]
image::d1/devops-pipeline-run-java-3.png[link="self",window=_blank]

Verify PipelineRun has been completed with success:

[.bordershadow]
image::d1/devops-pipeline-run-java-4.png[link="self",window=_blank]
