...
[.bordershadow]
image::d1/parksmap-permissions-namespace.png[link="self",window=_blank]

Select the *Role Bindings* tab and filter by *Namespace Role Binding* to see all permissions for the selected project.

[.bordershadow]
image::d1/parksmap-permissions-membership.png[link="self",window=_blank]
...
+
image::d1/parksmap-permissions-membership-serviceaccount-list.png[link="self",window=_blank]
+
...
+
image::d1/parksmap-permissions-membership-serviceaccount-edit.png[link="self",window=_blank]
+
...
+
image::d1/parksmap-permissions-membership-serviceaccount-done.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-permissions-redeployed.png[link="self",window=_blank]
