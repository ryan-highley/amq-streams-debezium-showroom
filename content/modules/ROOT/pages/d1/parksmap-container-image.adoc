...
[.bordershadow]
image::d1/roadshow-app-architecture-parksmap-1.png[link="self",window=_blank]
...
In the *OCP Console* tab, navigate to the *Topology* view in the *{ocp4_starter_project}* project.

At the top right, click the *+* icon. You will see a menu where you have multiple options to deploy application to OpenShift. Click *Container images* to open a dialog that will allow you to specify the information for the image you want to deploy.

[.bordershadow]
image::d1/openshift-console-add-container.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-image.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-image-options.png[width=600,link="self",window=_blank]

[.bordershadow]
image::d1/parksmap-advanced-image-options.png[width=600,link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-dc-topology.png[width=400,link="self",window=_blank]
...
[.bordershadow]
image::d1/switchtoresources.png[link="self",window=_blank]

On that panel, you will see that there is a single *Pod* that was created by your actions.

[.bordershadow]
image::d1/parksmap-overview.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-podlist.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-dc-resources.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-pod.png[link="self",window=_blank]

[.bordershadow]
image::d1/parksmap-pod-events.png[link="self",window=_blank]
...
link:{ocp4_starter_openshift_docs}/html/networking_overview[Services,window='_blank'],
...
[.bordershadow]
image::d1/parksmap-serviceslist.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-service.png[link="self",window=_blank]
