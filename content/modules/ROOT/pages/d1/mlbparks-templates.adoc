...
image::d1/deprecated/roadshow-app-architecture-mlbparks.png[Application architecture,800,align="center",link="self",window=_blank]
...
image::d1/deprecated/mlbparks-templates-complete-overview.png[Complete overview,link="self",window=_blank]
...
image::d1/deprecated/mlbparks-templates-dev-catalog.png[Template in Developer Catalog,link="self",window=_blank]
...
image::d1/deprecated/mlbparks-templates-yaml-menu.png[Complete overview,link="self",window=_blank]

On the next page, click *YAML* to see/edit the YAML from here.

image::d1/deprecated/mlbparks-templates-yaml-edit.png[Template YAML edit,link="self",window=_blank]
