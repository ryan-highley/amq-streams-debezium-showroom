...
[.bordershadow]
image::d1/parksmap-details.png[link="self",window=_blank]

Next, click the *^* icon next to the Pod visualization to scale up to 2 pods.

[.bordershadow]
image::d1/parksmap-scaleup.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/parksmap-scaled.png[link="self",window=_blank]
