...
[.bordershadow]
image::d1/nationalparks-application-health-menu.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/nationalparks-application-health-settings.png[link="self",window=_blank]
...
[.bordershadow]
image::d1/nationalparks-application-health-add.png[link="self",window=_blank]
