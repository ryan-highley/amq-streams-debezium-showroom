...
image::d1/deprecated/mlbparks-debugging-intellij-debug-new.png[IntelliJ run and debug configurations dialog,link="self",window=_blank]
...
image::d1/deprecated/mlbparks-debugging-intellij-debug-info.png[IntelliJ remote debug configuration with port 8787,link="self",window=_blank]
